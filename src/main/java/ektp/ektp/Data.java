...
public class Data implements Serializable {
    ...
    public Data(Integer id, String noktp, String nama, Date tgllahir, String jeniskelamin, String alamat, String agama, String status, String pekerjaan, String warganegara, String berlakuhingga, byte[] foto) {
        this.id = id;
        this.noktp = noktp;
        this.nama = nama;
    ...
    public String toString() {
        return "ektp.ektp.Data[ id=" + id + " ]";
    }

    void setBerlakuhinga(String berlaku) {
